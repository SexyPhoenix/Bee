    ...
    <div class="col-md-12">
      <el-card shadow="never">
        ...
        >
          ...
          <el-table-column label="办公地点" prop="address" width="160" show-overflow-tooltip></el-table-column>
      ...
      <affairs-approval :item="form.applyIds" :show="showApproval" @pick="handleSubmit"></affairs-approval>
    </div>
  </div>
</template>
<script>
import WorkFlow from '../WorkFlow'
import AffairsApproval from '../../../components/bee/flow/AffairsApproval'
...
export default {
  ...
  computed: {
    ...mapState({
      applies: state => state.flow.affairsItems.data,
  ...
  methods: {
    ...
    getApplyData() {
      ...
      this.GET_AFFAIRS_APPLY_DATA(this.query).then(() => {
    ...
    initFilterStatus() {
      ...
      this.filterStatus = UtilApply.getAffairsStatus()

      this.query.status = UtilApply.getAffairsDefaultStatus()   
    },
    initFilterType() {
